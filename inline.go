			...
			"findLastIndex": {
				...
				value: Value{
					...
					value: &object{
						...
						value: nativeFunctionObject{
							name: "findLastIndex",
							call: builtinArrayFindLastIndex,
						},
					},
				},
			},
